...
$restaurants = new Restaurant ();
    ...
    <main class="py-18 px-64 flex justify-center">
        <form class="w-1/2 bg-green-800 rounded-lg p-12 m-12 text-black" action="createRestaurantController.php" method="post">
            <div class="mb-5">
            ...
            <div class="mb-5">
                <label class="text-white" for="leeftijd">Locatie</label>
