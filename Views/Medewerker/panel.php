...
<main class="py-24 px-64">
    <div class="grid gap-x-20 gap-y-10 grid-cols-2 grid-rows-2 ">
        ...
        <div class="border-4 border-gray-800 rounded-xl p-3 text-center ">
            <div class="rounded-xl"><h2 class="text-3xl font-bold hover:text-gray-700"><span
                ...
                <div class="mb-4"><br>
                    <span class="hover:bg-gray-800 hover:text-white p-3 border-2 rounded-lg text-center border-green-800"><a
                                href="">Create</a></span>
                    <span class="hover:bg-gray-800 hover:text-white p-3 border-2 rounded-lg text-center border-green-800"><a
                                href="">Read</a></span>
                    <span class="hover:bg-gray-800 hover:text-white p-3 border-2 rounded-lg text-center border-green-800"><a
